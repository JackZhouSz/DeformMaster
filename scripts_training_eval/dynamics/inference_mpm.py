...
Usage:
    python scripts_training_eval/dynamics/inference_mpm.py --case_name double_lift_sloth --config configs/softbody.yaml
    python scripts_training_eval/dynamics/inference_mpm.py --case_name double_lift_cloth_1 --config configs/cloth.yaml
    python scripts_training_eval/dynamics/inference_mpm.py --case_name single_push_rope --config configs/rope.yaml
"""
...
def render_inference_video(case_name, base_path, trajectory_path, video_path):
    ...
    camera view. Mirrors inference_warp.py's output format."""

    from deformmaster.utils.visualize_pc import visualize_pc
